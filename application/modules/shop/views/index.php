                    ...
                    if (!empty($data)) {
                        foreach ($data as $key => $value) {
                            ...
                            echo '<td>                            
                                        ...
                                        <button type="button" onclick="editShop(' . $value->id . ')" class="btn btn-primary">Edit</button>
                                        <button type="button" onclick="deleteFn(' . $value->id . ', \'shop\', \'shop\', \'shop/delete\')" class="btn btn-danger">Delete</button>
...
<div class="modal" tabindex="-1" id="addShopModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addShopModal_title">Add Shop</h5>
...
<script src="<?= base_url() ?>assets/custom/js/shop/shop.js"></script>
